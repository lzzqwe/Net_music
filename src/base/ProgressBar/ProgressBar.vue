...
export default {
  ...
  methods:{
    ...
    progressTouchMove(e) {
      ...
      const offsetWidth = Math.min(this.$refs.progressBar.clientWidth - progressBtnWidth, Math.max(0, this.touch.width + distance))
  ...
  watch:{
     percent(newPercent) {
        ...
        this.$refs.btnWrapper.style['transform'] = `translate3d(${progressWith}px,0,0)`
     }
  }
}
</script>
